...
//https://github.com/Malikir324/Unity-NavMesh-adding-Obstacles-To-Terrain-Trees?tab=readme-ov-file
public class SetTerrainObstaclesStatic : MonoBehaviour
{
    ...
    public static void BakeTreeObstacles()
    {
        ...
        foreach (TreeInstance tree in Obstacle)
        {
            ...
            int LayerIgnoreRaycast = LayerMask.NameToLayer("Obstacle");
            obs.layer = LayerIgnoreRaycast;
            ...
            if (coll.GetType() == typeof(CapsuleCollider) || coll.GetType() == typeof(BoxCollider))
            {
                if (coll.GetType() == typeof(CapsuleCollider))
                {
                    ...
                    CapsuleCollider col = obsElement.AddComponent<CapsuleCollider>();
                    col.center = capsuleColl.center;
                    col.radius = capsuleColl.radius;
                    col.height = capsuleColl.height;
                ...
                else if (coll.GetType() == typeof(BoxCollider))
                {
                    ...
                    BoxCollider col = obsElement.AddComponent<BoxCollider>();
                    col.center = boxColl.center;
                    col.size = boxColl.size;
                }
